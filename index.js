...
var cert2 = fs.readFileSync(__dirname + "/etc/letsencrypt/live/instance2mymachines.xyz/cert.pem");
var key = fs.readFileSync("/etc/letsencrypt/live/instance2mymachines.xyz/privkey.pem")
console.log(cert2)
console.log(key)
